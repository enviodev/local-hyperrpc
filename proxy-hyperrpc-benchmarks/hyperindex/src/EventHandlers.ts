...
const INITIAL_EVENTS_SUMMARY: EventsSummaryEntity = {
  ...
  const nextSummaryEntity = {
    ...
    rocketTokenRETH_ApprovalCount: currentSummaryEntity.rocketTokenRETH_ApprovalCount + BigInt(1),
  };
  ...
  const nextSummaryEntity = {
    ...currentSummaryEntity,
    rocketTokenRETH_TransferCount: currentSummaryEntity.rocketTokenRETH_TransferCount + BigInt(1),
  };
